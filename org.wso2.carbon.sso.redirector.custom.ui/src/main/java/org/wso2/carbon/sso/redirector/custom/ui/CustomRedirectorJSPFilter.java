 ...
 * to stratos-auth-custom/redirect_ajaxprocessor.jsp
 */
public class CustomRedirectorJSPFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse,
        ...
        url = url.replace("stratos-auth/redirect_ajaxprocessor.jsp", "stratos-auth-custom/redirect_ajaxprocessor.jsp");
