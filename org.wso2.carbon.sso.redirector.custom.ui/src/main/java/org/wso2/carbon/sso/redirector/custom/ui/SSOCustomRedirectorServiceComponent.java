...
package org.wso2.carbon.sso.redirector.custom.ui;
...
/**
 * @scr.component name="org.wso2.carbon.sso.redirector.custom.ui"
 * immediate="true"
 */
public class SSOCustomRedirectorServiceComponent {
    private static Log log = LogFactory.getLog(SSOCustomRedirectorServiceComponent.class);
...
//        redirectorPageFilterParams.put("url-pattern", "/carbon/sso-acs/redirect_ajaxprocessor.jsp");
    ...
    protected void deactivate(ComponentContext ctxt) {
        ...
        log.debug("Stratos SSO Custom Redirector bundle is deactivated..");
    }
}
